 ...
 */
class Panel extends NObject implements IBarPanel
{
	...
	public function __construct(NDIContainer $container, IEditable $translator, $layout = NULL, $height = NULL)
	{
	 ...
	 * @param int $height
	 */
	public static function register(NDIContainer $container, IEditable $translator, $layout = NULL, $height = NULL)
	{
		NDebugger::$bar->addPanel(new static($container, $translator, $layout, $height));
	}
}